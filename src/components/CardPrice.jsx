...
const CardPrice = ({
  ...
  return (
    <div
      data-aos={animation}
      className="p-6 md:p-8 z-10 rounded-3xl shadow-lg shadow-black dark:shadow-slate-400 w-[340px] md:w-[450px] md:h-[620px] hover:bg-yellow-100 dark:bg-slate-100 dark:hover:bg-yellow-100"
    >
