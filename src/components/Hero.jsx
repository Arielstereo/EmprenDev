      ...
      <div className="flex flex-col mt-12 gap-2 text-center mx-auto px-3 sm:px-4 max-w-4xl">
        <div className="flex justify-center items-center md:mb-8 mb-4">
          <div className="flex flex-col gap-2">
            <h1 className="text-5xl lg:text-8xl gradient-blue font-bold leading-tight">
              Soluciones digitales
            </h1>
            <h1 className="text-slate-800 dark:text-slate-100 text-5xl lg:text-8xl font-bold leading-tight">
              personalizadas
            </h1>
          </div>
        </div>
        <div className="w-full mx-auto animate__animated animate__fadeInUp animate__slower">
        ...
        <div className="w-3/4 mx-auto mt-6 sm:mt-8 flex flex-col sm:flex-row gap-3 sm:gap-4 md:gap-8 justify-center">
          <a
