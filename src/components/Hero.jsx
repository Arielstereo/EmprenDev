...
const Hero = () => {
  return (
    <header className="flex justify-center h-full mt-48 lg:mt-32 pb-40">
      <div className="flex flex-col md:mt-12 gap-2 text-center mx-auto">
        <div className="flex justify-center items-center md:mb-8">
          <div className="flex flex-col gap-2">
            <h1 className="text-3xl md:text-8xl gradient-blue">
              Soluciones digitales
            </h1>
            <h1 className="text-slate-800 dark:text-slate-100 text-3xl md:text-8xl">
              personalizadas
            </h1>
          </div>
        </div>
        <div className="w-5/6 md:w-1/2 mx-auto animate__animated animate__fadeInUp animate__slower">
